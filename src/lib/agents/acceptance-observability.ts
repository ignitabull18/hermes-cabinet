...
export function recordAcceptanceRuntimeObservation(
  ...
  observations.set(conversationId, {
    ...
    toolEventCount:
      value.toolEventCount === undefined
        ? current.toolEventCount
        : boundedCount(value.toolEventCount),
    decisionEventCount:
      value.decisionEventCount === undefined
        ? current.decisionEventCount
        : boundedCount(value.decisionEventCount),
    duplicateChunkCount:
      value.duplicateChunkCount === undefined
        ? current.duplicateChunkCount
        : boundedCount(value.duplicateChunkCount),
    mcpServerCount:
      value.mcpServerCount === undefined
        ? current.mcpServerCount
        : boundedCount(value.mcpServerCount),
